      ...
      <nav aria-label="Page navigation example">
        <ul className="flex items-center list-style-none">
          <li className="page-item">
            <Link
              className="page-link relative block py-1.5 px-3 border-0 outline-none transition-all duration-300 rounded text-gray-800 hover:text-gray-800 focus:shadow-none"
            ...
            >
              <Link
                className={clsx(
                  ...
                  {
                    "shadow-sm text-white hover:text-white hover:bg-blue-700":
                      page === currentPage,
                  }
                )}
